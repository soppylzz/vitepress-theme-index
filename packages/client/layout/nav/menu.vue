...
import { VtiPopper, VtiMenu } from "../../components";
...
const hasContent = useHasProps(props, ["icon", "text"]);
const hasText = useHasProps(props, "text");
...
<template>
  <div v-if="hasContent" :class="kls.wrap">
    <VtiPopper
      v-if="isHeaderMode"
      mode="block"
      placement="top"
